...
echo "  3. Send Kafka message: kubectl run kafka-producer --image=confluentinc/cp-kafka:7.4.0 --rm -it --restart=Never -- kafka-console-producer --bootstrap-server kafka-service:9092 --topic user-events"
echo ""
